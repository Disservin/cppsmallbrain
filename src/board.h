...
struct MA {
    std::vector<Pertft_Info> info_array;
};
...
public:
    ...
    */
    ...
    //en passant square
    uint8_t en_passant_square = no_sq;
    ...
    static constexpr U64 File1 = 9259542123273814144ULL;
    static constexpr U64 File8 = 72340172838076673ULL;
	
    //Ranks
    static constexpr U64 rank_1_mask = 255ULL;
    static constexpr U64 rank_2_4_mask = 18446744069431296255ULL;
    static constexpr U64 rank_7_5_mask = 18374966859431673855ULL;
    static constexpr U64 rank_8_mask = 18374686479671623680ULL;
    static constexpr U64 Rank2 = 65280ULL;
    static constexpr U64 Rank7 = 71776119061217280ULL;
    ...
    int8_t piece_at_square(int8_t sq);

    int8_t piece_at(int8_t sq, int given = -1);

    int8_t piece_type_at(int8_t sq);

    int8_t piece_to_piece_type(int8_t piece);
		
    std::string piece_type(int8_t piece);
    ...
    U64 legal_pawn_moves(bool IsWhite, int8_t sq, uint8_t ep = 64);

    U64 legal_knight_moves(bool IsWhite, int8_t sq);

    U64 legal_bishop_moves(bool IsWhite, int8_t sq);

    U64 legal_rook_moves(bool IsWhite, int8_t sq);
